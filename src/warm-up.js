...
// Initialize three new variables, "food", "type" and "inStock", and assign
// values to them with a food's name, type and number of items in stock.
...
// Reassign (not initialize) your "inStock" variable from above.
...
// Reassign (not initialize) your "inStock" variable from above.
// You got hungry and needed a snack!
...
// Express the following in code: If the variable "stockCount" is greater or
// equal to 1, log the statement 'I'm going to eat some [food]!', otherwise,
// log the statement 'We need to get some more [food].'

var stockCount = 4;

function canEatFood(stock) {
  if (stock >= 1) {
...
var vegetables = ["garlic", "onion", "carrot", "bell pepper", "celery"];
...
var fruits = ["pear", "banana", "kiwi", "mango", "apple", "plum", "strawberry"];
...
// Create a new variable called "groceryStore" and assign to it an object literal
// with two keys: name, and isOpen. The value for name should the string 'King Soopers'
// (or your favorite grocery store), and the value for isOpen should be true.
...
groceryStore.storeNumber = 31;
groceryStore.isOnline = true;
groceryStore.departments = ["produce", "deli", "floral", "frozen", "dry goods", "bakery"];
